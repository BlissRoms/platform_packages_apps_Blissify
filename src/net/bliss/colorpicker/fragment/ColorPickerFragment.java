...
package net.bliss.colorpicker.fragment;
...
import net.bliss.colorpicker.widget.ApplyColorView;
import net.bliss.colorpicker.widget.ColorPickerView;
import net.bliss.colorpicker.widget.ColorViewButton;
import net.bliss.colorpicker.util.ColorPickerHelper;
...
public class ColorPickerFragment extends Fragment implements
    ...
    private void setUpPaletteColorButtons() {
        ...
        TypedArray colors = mResources.obtainTypedArray(R.array.color_picker_bliss_palette);
        ...
        for (int i=0; i<3; i++) {
            ...
            int titleResId = R.string.palette_bliss_title;
