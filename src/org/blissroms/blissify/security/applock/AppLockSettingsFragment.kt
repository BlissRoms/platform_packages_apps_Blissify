...
package org.blissroms.blissify.security.applock
...
class AppLockSettingsFragment : DashboardFragment(),
    ...
    override protected fun getPreferenceScreenResId() = R.xml.blissify_app_lock

    override fun getMetricsCategory() = MetricsProto.MetricsEvent.BLISSIFY
