...
import static com.android.internal.util.bliss.ThemeUtils.FONT_KEY;
...
public class Fonts extends BlissifyFragment {
  ...
  public class Adapter extends RecyclerView.Adapter<Adapter.CustomViewHolder> {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      View v =
          LayoutInflater.from(parent.getContext()).inflate(R.layout.fonts_option, parent, false);
    ...
    public void onBindViewHolder(CustomViewHolder holder, final int position) {
      ...
      String currentPackageName =
          mThemeUtils.getOverlayInfos(mCategory).stream()
  ...
  public Typeface getTypeface(Context context, String pkg) {
    try {
      ...
      Resources res =
          pkg.equals("android") ? Resources.getSystem() : pm.getResourcesForApplication(pkg);
      return Typeface.create(
          res.getString(res.getIdentifier("config_bodyFontFamily", "string", pkg)),
          Typeface.NORMAL);
