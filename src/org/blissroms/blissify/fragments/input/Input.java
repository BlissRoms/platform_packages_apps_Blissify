...
package org.blissroms.blissify.fragments.input;
...
public class Input extends BlissifyFragment implements Preference.OnPreferenceChangeListener {
  ...
  public void onCreate(Bundle icicle) {
    ...
    addPreferencesFromResource(R.xml.blissify_input);

    Action threeFingersSwipeAction =
        Action.fromSettings(
            getContentResolver(),
  ...
  private void handleListChange(ListPreference pref, Object newValue, String setting) {
    ...
    LineageSettings.System.putIntForUser(
        getContentResolver(), setting, Integer.valueOf(value), UserHandle.USER_CURRENT);
  }
  ...
  public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
      new BaseSearchIndexProvider(R.xml.blissify_input);
}
