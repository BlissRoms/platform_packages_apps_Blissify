...
import org.blissroms.blissify.preferences.SystemPropertySwitchPreference;
...
public class Spoofing extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mUpdateJsonButton.setOnPreferenceClickListener(preference -> {
            updatePropertiesFromUrl("https://raw.githubusercontent.com/BlissRoms/.github/refs/heads/main/profile/pif.json");
            return true;
        });
