...
public class UdfpsAnimations extends BlissifyFragment {

  private RecyclerView mRecyclerView;
  private String mPkg = "org.blissroms.udfps.animations";
  ...
  private void loadResources() {
    ...
    mAnims =
        udfpsRes.getStringArray(udfpsRes.getIdentifier("udfps_animation_styles", "array", mPkg));
    mAnimPreviews =
        udfpsRes.getStringArray(udfpsRes.getIdentifier("udfps_animation_previews", "array", mPkg));
    mTitles =
        udfpsRes.getStringArray(udfpsRes.getIdentifier("udfps_animation_titles", "array", mPkg));
  }
    ...
    public void onBindViewHolder(UdfpsAnimViewHolder holder, final int position) {
      ...
      if (position
          == Settings.System.getInt(
              context.getContentResolver(), Settings.System.UDFPS_ANIM_STYLE, 0)) {
          ...
          new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              Settings.System.putInt(
                  getActivity().getContentResolver(), Settings.System.UDFPS_ANIM_STYLE, position);
            }
          });
    }
