...
public class SystemSettings extends BlissifyDashboardFragment {

  public static final String TAG = "SystemSettings";

  private static final String KEY_SYSTEM_FLASHLIGHT = "system_flashlight";
  ...
  protected int getPreferenceScreenResId() {
    return R.xml.blissify_system;
  }

  public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
      new BaseSearchIndexProvider(R.xml.blissify_system) {

        @Override
        public List<String> getNonIndexableKeys(Context context) {
          List<String> keys = super.getNonIndexableKeys(context);
          if (!BlissUtils.deviceHasFlashlight(context)) {
            keys.add(KEY_SYSTEM_FLASHLIGHT);
          }
          return keys;
        }
      };
