...
package org.blissroms.blissify.preferences;
...
public class CustomSeekBarPreference extends SliderPreference {
  ...
  @Nullable private String mUnits = "";
  @Nullable private String mDefaultValueText;
  ...
  private void readLegacyAttrs(Context c, AttributeSet attrs) {
    ...
    try {
      ...
      final boolean continuous =
          a.getBoolean(R.styleable.CustomSeekBarPreference_continuousUpdates, false);
  ...
  public void onBindViewHolder(@NonNull PreferenceViewHolder holder) {
    ...
    if (labelFrame != null) {
      boolean hasStart =
          startText != null && startText.getText() != null && startText.getText().length() > 0;
      boolean hasEnd =
          endText != null && endText.getText() != null && endText.getText().length() > 0;
      boolean parentWantsLabels = hasStart || hasEnd;

      labelFrame.setVisibility(
          (parentWantsLabels || mDefaultValueExists) ? View.VISIBLE : View.GONE);
    }
    ...
    ViewGroup minusFrame =
        (ViewGroup)
            holder.findViewById(
                com.android.settingslib.widget.preference.slider.R.id.icon_start_frame);
    ImageView minusIcon =
        (ImageView)
            holder.findViewById(com.android.settingslib.widget.preference.slider.R.id.icon_start);
    ...
    final Slider slider =
        (Slider) holder.findViewById(com.android.settingslib.widget.preference.slider.R.id.slider);
  ...
  private void updatePlusMinusEnabledStates(PreferenceViewHolder holder) {
    View minusFrame =
        holder.findViewById(com.android.settingslib.widget.preference.slider.R.id.icon_start_frame);
    ImageView minusIcon =
        (ImageView)
            holder.findViewById(com.android.settingslib.widget.preference.slider.R.id.icon_start);
    View plusFrame =
        holder.findViewById(com.android.settingslib.widget.preference.slider.R.id.icon_end_frame);
    ImageView plusIcon =
        (ImageView)
            holder.findViewById(com.android.settingslib.widget.preference.slider.R.id.icon_end);
