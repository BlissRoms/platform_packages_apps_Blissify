...
public class ColorPickerView extends View {
  ...
  /**
   * Offset from the edge we must have or else the finger tracker will get clipped when it is drawn
   * outside of the view.
   */
  ...
  private void drawSatValPanel(Canvas canvas) {
    ...
    if (mValShader == null) {
      mValShader =
          new LinearGradient(
              rect.left, rect.top, rect.left, rect.bottom, 0xffffffff, 0xff000000, TileMode.CLAMP);
    }
   ...
   * side of a panel to the side of the view minus the padding. Useful if you want to have your own
   * panel below showing the currently selected color and want to align it perfectly.
   *
