...
package com.blissroms.blissify.button;
...
import com.blissroms.blissify.button.tabs.NavButton;
import com.blissroms.blissify.button.tabs.NavigationBar;
   ...
   @Override
    ...
    class StatusBarAdapter extends FragmentPagerAdapter {
        ...
        public StatusBarAdapter(FragmentManager fm) {
            super(fm);
	    frags[0] = new NavButton();
	    frags[1] = new NavigationBar();
        }
    ...
    private String[] getTitles() {
        ...
        titleString = new String[]{
		    getString(R.string.nav_button_title),
