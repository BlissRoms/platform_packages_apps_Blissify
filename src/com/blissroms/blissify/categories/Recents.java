...
import com.blissroms.blissify.fragments.recents.Style;
...
public class Recents extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new RecentsAdapter(getChildFragmentManager()));
    ...
    private class RecentsAdapter extends FragmentPagerAdapter {
            ...
            titleString = new String[]
                    {
                      // Add Tab Fragment Title
                        getString(R.string.recents_style_title)
