...
public class CutoutFragment extends SettingsPreferenceFragment
    ...
    private SystemSettingSwitchPreference mPillHide;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPillHide = (SystemSettingSwitchPreference) findPreference(KEY_DUAL_NOTCH_PILL_HIDE);
