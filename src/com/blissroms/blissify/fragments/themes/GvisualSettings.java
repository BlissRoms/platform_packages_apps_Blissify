...
public class GvisualSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.bliss_settings_gvisual);
    ...
    private void setupNavbarSwitchPref() {
        ...
        } else if (BlissUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_orcd")){
    ...
    private void setupHeaderSwitchPref() {
        ...
        if (BlissUtils.isThemeEnabled("com.android.theme.header.xlarge")){
            mhdSize.setValue("3");
        } else if (BlissUtils.isThemeEnabled("com.android.theme.header.large")){
            mhdSize.setValue("2");
        }
        else{
            mhdSize.setValue("1");
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.bliss_settings_gvisual);
}
