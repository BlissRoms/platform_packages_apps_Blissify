...
public class StockStyles extends SettingsPreferenceFragment  implements Preference.OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.stock_recents_styles);
    ...
    private void resetToDefault() {
        ...
        alertDialog.setMessage(R.string.bliss_reset_message);
