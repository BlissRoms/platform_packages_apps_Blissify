...
public class Notifications extends SettingsPreferenceFragment implements
    ...
    private static final String ALERT_SLIDER_PREF_CATEGORY = "alert_slider_category";
    ...
    public void onCreate(Bundle icicle) {
        ...
        mTickerSettings = (PreferenceCategory) prefSet.findPreference(TICKER_SETTINGS);
        if (DeviceUtils.hasNotch(mContext))
            prefSet.removePreference(mTickerSettings);
        ...
        mAlertSlider = (PreferenceCategory) findPreference(ALERT_SLIDER_PREF_CATEGORY);
