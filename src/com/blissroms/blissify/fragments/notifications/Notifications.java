...
public class Notifications extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        edgeLightColor = Settings.System.getInt(getContentResolver(),
        ...
        mEdgeLightAutoColor.setOnPreferenceChangeListener(this);
    }
        ...
        if (preference == mHeadsUpEnabled) {
            ...
            try {
                ...
                if (bitmap != null) {
                        ...
                        int wallColor = p.getDominantColor(edgeLightColor);
                        if (edgeLightColor != wallColor)
                        edgeLightColor = wallColor;
            ...
            Settings.System.putInt(getContentResolver(),
                    Settings.System.PULSE_AMBIENT_AUTO_COLOR, value);
            return true;
