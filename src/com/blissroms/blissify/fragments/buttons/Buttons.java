...
import com.blissroms.blissify.fragments.buttons.ButtonBacklightBrightness;
import com.blissroms.blissify.fragments.buttons.PowerMenuActions;
...
public class Buttons extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        boolean showing = LineageSettings.System.getIntForUser(resolver,
                ...
                BlissUtils.hasNavbarByDefault(getActivity()) ? 1 : 0, UserHandle.USER_CURRENT) != 0;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mHardwareKeysDisable) {
            ...
            LineageSettings.System.putIntForUser(getActivity().getContentResolver(), LineageSettings.System.FORCE_SHOW_NAVBAR,
    ...
    public static void reset(Context mContext) {
        ...
        LineageSettings.System.putIntForUser(resolver, LineageSettings.System.FORCE_SHOW_NAVBAR,
             BlissUtils.hasNavbarByDefault(mContext) ? 1 : 0, UserHandle.USER_CURRENT);
    }
