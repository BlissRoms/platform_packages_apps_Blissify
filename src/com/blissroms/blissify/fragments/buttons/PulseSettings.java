...
public class PulseSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.blissify_settings_pulse);
        ...
        mColorPickerPref.setDefaultValue(BlissUtils.getThemeAccentColor(getContext()));
        ...
        if (colorMode == COLOR_TYPE_ACCENT) {
            mColorPickerPref.setNewPreviewColor(BlissUtils.getThemeAccentColor(getContext()));
        }
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() {
        ...
        public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
            ...
            sir.xmlResId = R.xml.blissify_settings_pulse;
            result.add(sir);
            return result;
        }
