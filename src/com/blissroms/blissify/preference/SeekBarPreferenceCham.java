...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String BLISSIFY = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, BLISSIFY, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, BLISSIFY, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(BLISSIFY, "interval");
            if(newInterval != null)
